...
**This role is based on stackhpc.cluster-infra role but with modifications for the CLIP environment**
...
`cluster_params`: Parameters that are passed in to the Heat stack.
  ...
  * `cluster_dns_zone`: DNS zone to create the hostnames in (optional)
  ...
  * `cluster_config_drive`: Whether to provide metadata vihttps://bitbucket.imp.ac.at/projects/CLIP/repos/cluster-infra/browsea a config drive.
    Default is `false`.https://bitbucket.imp.ac.at/projects/CLIP/repos/cluster-infra/browse
https://bitbucket.imp.ac.at/projects/CLIP/repos/cluster-infra/browse
  * `cluster_net`: JSON-structure list of networks, each ohttps://bitbucket.imp.ac.at/projects/CLIP/repos/cluster-infra/browsef which is described
    by a dict, containing the following:https://bitbucket.imp.ac.at/projects/CLIP/repos/cluster-infra/browse
https://bitbucket.imp.ac.at/projects/CLIP/repos/cluster-infra/browse
    ...
    - hosts: openstack
      roles:
        - role: stackhpc.cluster-infra
          ...
          cluster_params:
            cluster_dns_zone: "dev.clip.vbc.ac.at."
            cluster_prefix: "ohpc"
